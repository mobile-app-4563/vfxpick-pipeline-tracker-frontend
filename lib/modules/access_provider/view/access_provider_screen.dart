...
class _AccessProviderScreenState extends State<AccessProviderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        // ── Permission Matrix & Audit Log side by side ──
        SizedBox(
                    ...
                    Expanded(
                      child: rows.isEmpty
                          ? const EmptyStateWidget(
                              ...
                              description:
                                  'Menu routes are unavailable right now.',
                            )
                          : ListView(
  ...
  Widget _rolePill(BuildContext context, String role) {
    ...
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: SizeConfig.iconSize(context, 15), color: color),
  ...
  Widget _deptPill(BuildContext context, String dept) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: SizeConfig.scaleWidth(context, 10),
        vertical: SizeConfig.scaleHeight(context, 6),
